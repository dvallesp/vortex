...
!$OMP+                   ROTAX_1,ROTAY_1,ROTAZ_1,DXPA,DYPA,DZPA,COEF1,
!$OMP+                   COEF2,COEF3,COEF4),
!$OMP+            PRIVATE(I,N1,N2,N3,IX,JY,KZ,BAS32,BAS42,BAS23,BAS43,
!$OMP+                    BAS24,BAS34),
!$OMP+            DEFAULT(NONE)
       DO I=LOW1,LOW2
...
!$OMP+                   ROTAZ_0,COEF1,COEF2,COEF3,COEF4),
!$OMP+            PRIVATE(IX,JY,KZ,BAS23,BAS32,BAS24,BAS42,BAS34,BAS43),
!$OMP+            DEFAULT(NONE)
       DO KZ=1,NZ
       DO JY=1,NY
       DO IX=1,NX
...
*      ---PARALLEL---
     ...
     &           -1.0/280 /)
      ...
      LOW2=SUM(NPATCH(0:IR))
!$OMP PARALLEL DO SHARED(LOW1,LOW2,PATCHNX,PATCHNY,PATCHNZ,U12,U13,U14,
!$OMP+                   ROTAX_1,ROTAY_1,ROTAZ_1,DXPA,DYPA,DZPA,COEF3,
!$OMP+                   COEF4),
!$OMP+            PRIVATE(I,N1,N2,N3,IX,JY,KZ,BAS23,BAS32,BAS24,BAS42,
!$OMP+                    BAS34,BAS43),
!$OMP+            DEFAULT(NONE)
      DO I=LOW1,LOW2
...
!$OMP PARALLEL DO SHARED(LOW1,LOW2,PATCHNX,PATCHNY,PATCHNZ,U12,U13,U14,
!$OMP+                   DIVER,DXPA,DYPA,DZPA,COEF1,COEF2,COEF3,COEF4),
!$OMP+            PRIVATE(I,N1,N2,N3,IX,JY,KZ,BAS22,BAS33,BAS44),
!$OMP+            DEFAULT(NONE)
       DO I=LOW1,LOW2
       N1=PATCHNX(I)
       N2=PATCHNY(I)
...
!$OMP PARALLEL DO SHARED(NX,NY,NZ,U2,U3,U4,DIVER0,DX,DY,DZ,COEF1,COEF2,
!$OMP+                   COEF3,COEF4),
!$OMP+            PRIVATE(IX,JY,KZ,BAS22,BAS33,BAS44),
!$OMP+            DEFAULT(NONE)
       DO KZ=1,NZ
       DO JY=1,NY
       DO IX=1,NX
...
!$OMP+                   DZPA,U12P,U13P,U14P,COEF4,COEF3,DIVER),
!$OMP+            PRIVATE(I,N1,N2,N3,IX,JY,KZ,BAS22,BAS33,BAS44,
...
!$OMP PARALLEL DO SHARED(NX,NY,NZ,DX,DY,DZ,DIVER0,U2P,U3P,U4P,COEF1,
!$OMP+                   COEF2,COEF3,COEF4),
!$OMP+            PRIVATE(IX,JY,KZ,BAS22,BAS33,BAS44),
!$OMP+            DEFAULT(NONE)
       DO KZ=1, NZ
