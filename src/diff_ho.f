...
***********************************************************************
     ...
     &         RADZ(0:NMAZ+1),RADMZ(0:NMAZ+1)
       ...
       REAL*4 DXPA,DYPA,DZPA,XXX1,YYY1,ZZZ1
       REAL*4 bas23,bas34,bas24,bas32,bas43,bas42,AAA,BBB,CCC
       INTEGER CR1,CR2,CR3
       INTEGER MARK,ABUELO,KR1,KR2,KR3,IR_ABUE

       real*4 coef4(-4:4), coef3(-3:3), coef2(-2:2), coef1(-1:1)
       integer idx
...
***********************************************************************
     ...
     &         RADZ(0:NMAZ+1),RADMZ(0:NMAZ+1)
       ...
       REAL*4 DXPA,DYPA,DZPA,XXX1,YYY1,ZZZ1
       REAL*4 bas22,bas33,bas44,AAA,BBB,CCC
       INTEGER CR1,CR2,CR3
       INTEGER MARK,ABUELO,KR1,KR2,KR3,IR_ABUE
...
***********************************************************************
     ...
     &         RADZ(0:NMAZ+1),RADMZ(0:NMAZ+1)
       ...
       REAL*4 GRAD_P_X,GRAD_P_Y,GRAD_P_Z
...
* X
        ...
        if (ix.ge.5.and.ix.le.n1-4) then
         ...
         do idx=-1,1
           bas22 = bas22 + coef1(idx) * diver(ix+idx,jy,kz,i)
         end do
        end if
        bas22 = bas22 / dxpa
...
* Y
        ...
        if (jy.ge.5.and.jy.le.n2-4) then
         ...
         do idx=-1,1
           bas33 = bas33 + coef1(idx) * diver(ix,jy+idx,kz,i)
         end do
        end if
        bas33 = bas33 / dypa
...
* Z
        ...
        if (kz.ge.5.and.kz.le.n3-4) then
         ...
         do idx=-1,1
           bas44 = bas44 + coef1(idx) * diver(ix,jy,kz+idx,i)
         end do
        end if
        bas44 = bas44 / dzpa
