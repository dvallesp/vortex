...
************************************************************************
     ...
     &        RADZ(0:NMAZ+1),RADMZ(0:NMAZ+1)
      ...
      REAL*4 XX,YY,ZZ,XX1,YY1,ZZ1,XX2,YY2,ZZ2,BAS1,BAS2,BAS3
...
**********************************************************************
      ...
      INTEGER N1,N2,N3,I
      REAL*4 RX(-2:N1+3),RY(-2:N2+3),RZ(-2:N3+3)
      REAL*4 RMX(-2:N1+3),RMY(-2:N2+3),RMZ(-2:N3+3)
      REAL*4 RPAX,RPAY,RPAZ,DX,DY,DZ
...
***********************************************************************
     ...
     &         RADZ(0:NMAZ+1),RADMZ(0:NMAZ+1)
       ...
       REAL*4 UBAS(1:3,1:3,1:3),FUIN,RXBAS(3),RYBAS(3),RZBAS(3)
       REAL*4 AAA,BBB,CCC
