...
*     WRITE THE DIVERGENCE FIELD
      WRITE(25) (((DIVER0(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
      ...
      DO IR=1,NL
        ...
        DO I=LOW1,LOW2
          ...
          WRITE(25) (((SCR4(IX,J,K),K=1,N3),J=1,N2),IX=1,N1)

        END DO
      END DO

*     WRITE THE ROTATIONAL FIELDS (x, y, z)
      WRITE(25) (((ROTAX_0(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
      WRITE(25) (((ROTAY_0(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
      WRITE(25) (((ROTAZ_0(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
...
*     WRITE THE TOTAL VELOCITY FIELD (x, y, z)
      WRITE(25) (((U2(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
      WRITE(25) (((U3(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
      WRITE(25) (((U4(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
...
*     WRITE THE COMPRESSIONAL VELOCITY
      WRITE(25) (((U2P(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
      WRITE(25) (((U3P(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
      WRITE(25) (((U4P(I,J,K),K=1,NZ),J=1,NY),I=1,NX)
